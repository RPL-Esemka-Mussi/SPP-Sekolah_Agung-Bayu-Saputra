                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-grid">
                                    <a href="{{ url("/spp/edit/$data->id") }}" class="btn btn-sm btn-primary mb-1"><i class="bi bi-pencil-fill"></i> Edit</a>
                                    <a href="{{ url("/spp/destroy/$data->id") }}" class="btn btn-sm btn-danger"><i class="bi bi-trash3-fill"></i> Hapus</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
